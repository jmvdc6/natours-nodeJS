...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoiam12ZGMiLCJhIjoiY2tsNW4zbWhtMjlmODMwbXM1bDg4eHAxMiJ9.eHPWQaQT7KKcAzJw_HFVRg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/jmvdc/ckl5nmg174fha17mvgw4ugym0',
    scrollZoom: false //   center: [-118.6919205, 34.0201613],
    //   zoom: 10,
    // interactive: false,
...
var stripe = Stripe('pk_test_51ILVL0C9MSU5fHPvv8BXVrwMizzJqsGfLmh1lVWL7ymSTa2r3oxhpkvKldzWOrNFU6lcG1nb8gcGRyVD8BwrzuyM005gTHUPRU');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('err', _context.t0);
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value; // console.log('submit');
